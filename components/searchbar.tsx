	...
	return (
		<div className="relative col-span-1">
			...
			{query && (
				<>
					{isSearching && (
						<div className="absolute left-0 top-100 z-10 mt-1 flex w-full flex-col items-stretch overflow-hidden rounded-lg border bg-white p-1 text-left text-slate-900 shadow-2xl dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-50">
