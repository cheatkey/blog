...
<Image
  src={"/images/mermaid-compare.png"}
  alt={"flowchart 디자인 (기본 테마 vs beautiful mermaid)"}
/>

전체적으로 디자인을 하얗고, 둥글게 변경했고, 색상을 제거한 만큼 보기 쉽도록 쉐도우를 넣었습니다.

<Image
  src={"/images/meramid-compare-2.png"}
  alt={"sequence 디자인 (기본 테마 vs beautiful mermaid)"}
/>
...
<Image src={"/images/mermaid-text-match.png"} alt={"노드 하이라이팅"} />
