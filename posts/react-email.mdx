...
<Image src={"/images/steam-email.png"} alt={"steam 인증 이메일"} />

결제 완료를 안내해주기도 합니다.

<Image
  src={"/images/naver-pay-email.png"}
  alt={"네이버페이 결제 안내 이메일"}
/>
...
<Image src={"/images/react-email-build.png"} alt={"리액트 이메일 빌드 코드"} />
...
<Image src={"/images/react-email-html.png"} />
