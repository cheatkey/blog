...
const Post = ({ publication, post }: PostProps) => {
	...
	return (
		<>
			...
			<span
				className="absolute inset-0 hidden h-[64rem] overflow-hidden dark:block"
				style={{
					background:
						'radial-gradient(49.63% 57.02% at 58.99% -7.2%, rgba(85, 215, 153, 0.1) 39.4%, rgba(0, 0, 0, 0) 100%)',
				}}
			></span>
		...
		<AppProvider publication={publication} post={maybePost} page={maybePage}>
			<Layout>
				...
				<Container className="pt-10">
					<article className="flex flex-col items-start gap-10 pb-10 pt-20">
